    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          <a-col :md="8" :sm="24">
            <a-form-item label="">
              <a-input v-model="queryParam.key" placeholder="参数名"/>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <span>
...
import CreateForm from './unit-add-or-update'
export default {
  name: 'Unit',
  components: {
    STable,
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return this.$api.sys.getMessageList(Object.assign({ page: pageNo, limit: pageSize }, this.queryParam))
          .then(res => {
